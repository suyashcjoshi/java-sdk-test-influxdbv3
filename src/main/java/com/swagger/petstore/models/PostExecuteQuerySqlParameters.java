...
@EqualsAndHashCode
@Jacksonized
public class PostExecuteQuerySqlParameters {
  ...
  public static class PostExecuteQuerySqlParametersBuilder {

    private JsonNullable<GetExecuteQuerySqlAccept> accept = JsonNullable.undefined();

    @JsonProperty("Accept")
    public PostExecuteQuerySqlParametersBuilder accept(GetExecuteQuerySqlAccept value) {
      if (value == null) {
    ...
    @JsonProperty("Content-Type")
    public PostExecuteQuerySqlParametersBuilder contentType(ContentType value) {
      if (value == null) {
