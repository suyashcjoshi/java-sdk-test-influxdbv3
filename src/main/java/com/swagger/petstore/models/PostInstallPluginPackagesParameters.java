...
@EqualsAndHashCode
@Jacksonized
public class PostInstallPluginPackagesParameters {

  @NonNull
  private PostInstallPluginPackagesRequest requestBody;
  ...
  public static class PostInstallPluginPackagesParametersBuilder {

    private JsonNullable<ContentType> contentType = JsonNullable.undefined();

    @JsonProperty("Content-Type")
    public PostInstallPluginPackagesParametersBuilder contentType(ContentType value) {
      if (value == null) {
